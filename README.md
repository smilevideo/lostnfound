...
<b>~~Unfortunately~~ Fortunately, this is no longer necessary since an update revamped the speed system, but i'll keep it up anyway. Maybe the project can be updated for other games that still use the old bpm=scroll speed system.</b>
